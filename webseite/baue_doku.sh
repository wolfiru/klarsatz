...
<meta name="twitter:title" content="$titel — Klarsatz">
<meta name="twitter:description" content="$beschr">
...
<script type="application/ld+json">
{
 ...
 "itemListElement": [
  ...
  },
  {
   ...
   "position": 2,
   "name": "$titel",
   "item": "https://www.ruthner.at/klarsatz/$datei"
  }
 ]
}
</script>
...
<script defer src="assets/manuskript-bg.js?v=2"></script>
